...
const Logos = ({name, path}:logo) => {
    return (
        <li className="p-4 border border-transparent rounded-md" style={{
    ...
    <section>
      <div className="py-20 bg-[#f4f4f5]">
        <div className="container">
          <div className="max-w-3xl text-center pb-16 m-auto">
            <div className="w-20 h-20 shadow-md bg-white inline-flex justify-center items-center rounded-md mb-8">
              <a href="index.html">
