  ...
  return (
    <footer>
      <div className=" bg-[#f4f4f5] ">
        <div className="container flex flex-col sm:grid sm:grid-cols-12 py-12 gap-8 border-t-2">
          <div className="col-span-6 flex-col flex">
            <div className="mb-4">
              <div className="shadow-md w-7 bg-white p-1 rounded-md">
                <Image src={logo} alt="logo" width={24} height={24} />
              </div>
            </div>
            <div className="pera flex-grow">
              © Cruip.com. All rights reserved.
            </div>
            <ul className="flex mt-4 mb-1 gap-3">
              <li>
                <a className="" href="#0" aria-label="Twitter">
                  <svg
                    className="c6gvb"
              ...
              <li>
                <a className="" href="#0" aria-label="Medium">
                  <svg
                    className="c6gvb"
                    xmlns="http://www.w3.org/2000/svg"
                    width="20"
              ...
              <li>
                <a className="" href="#0" aria-label="Telegram">
                  <svg
                    className="c6gvb"
                    xmlns="http://www.w3.org/2000/svg"
                    width="20"
          ...
          <div className="col-span-6 md:col-span-3 lg:col-span-2">
            <h6 className="text-md mb-2 font-semibold text-black">Company</h6>
            <ul className="pera">
              <li>About us</li>
          ...
          <div className="col-span-6 md:col-span-3 lg:col-span-2">
            <h6 className="text-md mb-2 font-semibold text-black">Resources</h6>
            <ul className="pera">
              <li>Community</li>
          ...
          <div className="col-span-6 md:col-span-3 lg:col-span-2">
            <h6 className="text-md mb-2 font-semibold text-black">Legals</h6>
            <ul className="pera">
              <li>Refund policy</li>
